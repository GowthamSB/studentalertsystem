...
//var usnstu=document.forms["myform"]["idlogin"].value;
var usnstu=document.getElementById('idlogin');
var y=document.forms["myForm"]["idmail"].value;
var atpos=y.indexOf("@");
var dotpos=y.lastIndexOf(".");
 if(!usnstu.value.match(pattern))
			 {
...
<h1><b><center>STUDENTS REGISTRATION</center></b> </h1>
<br />

<h2>SET LOGIN AND PASSWORD</h2>

<form name="myForm" action="registertodb.jsp" onSubmit="return validateform();" method="post">
<table>
<tr> <td>USN</td><td><input style="height:25px;font-size:14pt;"type="text" name="usn" size="25" id="idlogin" value=""
/></td></tr>
<tr> <td>PASSWORD</td><td><input style="height:25px;font-size:14pt;" type="text" name="password" size="25" id="idpass" value=""
/></td></tr>
</table>

<h2>STUDENT DETAILS</h2>
<table>
<tr> <td>NAME</td><td><input type="text" style="height:25px;font-size:14pt;" name="name" id="idname" size="25" value=""
/></td></tr>
<tr> <td>BRANCH</td><td><input type="text" style="height:25px;font-size:14pt;" name="branch" id="idbranch" size="25" value=""
/></td></tr>
...
<tr> <td>EMAIL ID</td><td><input style="height:25px;font-size:14pt;" type="text" name="mailid" size="25" id="idmail" value=""
/></td></tr>
<tr> <td>PHONE NO.</td><td><input style="height:25px;font-size:14pt;" type="text" name="phno" id="idphno" size="25" value=""
/></td></tr>
</table>
</br>
...
<tr><td></td><td><input style="height:25px;width:100px;font-size:14pt;" type="submit" value="SAVE"  /></td></tr>
</form>
<div id="comments">
</br>
</br>
